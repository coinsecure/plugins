...
public class TradeSummaryDataResponse   {
   ...
   * true
   **/
  public TradeSummaryDataResponse success(Boolean success) {
  ...
  /**
   **/
  public TradeSummaryDataResponse message(TradeSummaryData message) {
  ...
  /**
   **/
  public TradeSummaryDataResponse method(String method) {
    this.method = method;
    return this;
  }
  ...
  /**
   **/
  public TradeSummaryDataResponse title(String title) {
    this.title = title;
    return this;
  }
  ...
  /**
   **/
  public TradeSummaryDataResponse time(Date time) {
    this.time = time;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.success, tradeSummaryDataResponse.success) &&
        Objects.equals(this.message, tradeSummaryDataResponse.message) &&
        Objects.equals(this.method, tradeSummaryDataResponse.method) &&
        Objects.equals(this.title, tradeSummaryDataResponse.title) &&
        Objects.equals(this.time, tradeSummaryDataResponse.time);
  }
