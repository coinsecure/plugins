...
module SwaggerClient
  class WalletActionsApi
    ...
    # @option opts [String] :accept JSON, XML or CSV can be returned (Optional)
    # @return [SuccessResult]
    def v1userwalletcoinwithdrawunverifiedcancel(authorization, body, opts = {})
      data, _status_code, _headers = v1userwalletcoinwithdrawunverifiedcancel_with_http_info(authorization, body, opts)
      return data
    end
    ...
    # @option opts [String] :accept JSON, XML or CSV can be returned (Optional)
    # @return [Array<(SuccessResult, Fixnum, Hash)>] SuccessResult data, response status code and response headers
    def v1userwalletcoinwithdrawunverifiedcancel_with_http_info(authorization, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: WalletActionsApi.v1userwalletcoinwithdrawunverifiedcancel ..."
      end
      # verify the required parameter 'authorization' is set
      fail ArgumentError, "Missing the required parameter 'authorization' when calling WalletActionsApi.v1userwalletcoinwithdrawunverifiedcancel" if authorization.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling WalletActionsApi.v1userwalletcoinwithdrawunverifiedcancel" if body.nil?
      # resource path
      local_var_path = "/v1/user/wallet/coin/withdraw/unverified/cancel".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :return_type => 'SuccessResult')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WalletActionsApi#v1userwalletcoinwithdrawunverifiedcancel\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
