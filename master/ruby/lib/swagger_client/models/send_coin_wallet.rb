...
module SwaggerClient
  ...
  class SendCoinWallet
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'amt')
        self.amt = attributes[:'amt']
      end

      if attributes.has_key?(:'toAddr')
        self.to_addr = attributes[:'toAddr']
      end
    ...
    def list_invalid_properties
      ...
      if @amt.nil?
        invalid_properties.push("invalid value for 'amt', amt cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @amt.nil?
      return false if @to_addr.nil?
      return true
    end
    ...
    def hash
      [wallet_id, amt, to_addr, msg, pin, fees].hash
    end
