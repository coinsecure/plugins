...
module SwaggerClient
  ...
  class SuccCoinRefData
    ...
    attr_accessor :new_user_id_masked

    attr_accessor :deposit_id

    attr_accessor :amt_paid
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'newUserIDMasked')
        self.new_user_id_masked = attributes[:'newUserIDMasked']
      end

      if attributes.has_key?(:'depositID')
        self.deposit_id = attributes[:'depositID']
      end

      if attributes.has_key?(:'amtPaid')
        self.amt_paid = attributes[:'amtPaid']
      end
    ...
    def list_invalid_properties
      ...
      if @new_user_id_masked.nil?
        invalid_properties.push("invalid value for 'new_user_id_masked', new_user_id_masked cannot be nil.")
      end

      if @deposit_id.nil?
        invalid_properties.push("invalid value for 'deposit_id', deposit_id cannot be nil.")
      end

      if @amt_paid.nil?
        invalid_properties.push("invalid value for 'amt_paid', amt_paid cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @new_user_id_masked.nil?
      return false if @deposit_id.nil?
      return false if @amt_paid.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ref_id == o.ref_id &&
          trade_id == o.trade_id &&
          new_user_id_masked == o.new_user_id_masked &&
    ...
    def hash
      [ref_percent, time, order_id, ref_id, trade_id, new_user_id_masked, deposit_id, amt_paid].hash
    end
