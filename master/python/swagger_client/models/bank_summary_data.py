...
class BankSummaryData(object):
    ...
    def __init__(self):
        ...
        self._pending_coin_balance = None
        self._pending_fiat_balance = None
        self._available_coin_balance = None
        self._available_fiat_balance = None
        self._total_coin_balance = None
        self._total_fiat_balance = None
        self._coin_fee_percentage = None
        self._fiat_fee_percentage = None
        self._bank_link_status = None
        self._has_trade_netki = False
        self._trade_netki_name = None
        self._trade_netki_address = None
