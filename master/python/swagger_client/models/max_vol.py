...
class MaxVol(object):
    ...
    def __init__(self, max_vol=None):
        """
        MaxVol - a model defined in Swagger
    ...
    def max_vol(self):
        """
        Gets the max_vol of this MaxVol.


        :return: The max_vol of this MaxVol.
        :rtype: int
        """
        return self._max_vol

    @max_vol.setter
    def max_vol(self, max_vol):
        """
        Sets the max_vol of this MaxVol.
