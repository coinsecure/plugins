...
class TradeSummaryData(object):
    ...
    def __init__(self):
        ...
        self._completed_asks_sum = None
        self._completed_bids_sum = None
        self._completed_asks_count = None
        self._completed_bids_count = None
        self._pending_asks_count = None
        self._pending_bids_count = None
