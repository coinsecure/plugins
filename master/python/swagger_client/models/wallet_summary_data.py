...
class WalletSummaryData(object):
    ...
    def __init__(self):
        ...
        self._wallet_confirmed_balance = None
        self._wallet_uncofirmed_balance = None
        self._has_wallet_netki = False
        self._wallet_netki = None
        self._wallet_netki_address = None
        self._wallet_netki_wallet_id = None
