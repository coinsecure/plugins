...
class BlockchainToolsApi(object):
    ...
    def v1bitcoinsearch_address(self, any, **kwargs):
        ...
        if kwargs.get('callback'):
            return self.v1bitcoinsearch_address_with_http_info(any, **kwargs)
        else:
            (data) = self.v1bitcoinsearch_address_with_http_info(any, **kwargs)
            return data

    def v1bitcoinsearch_address_with_http_info(self, any, **kwargs):
        """
        Search Bitcoin Blockchain
        Searches for a Bitcoin Address, Netki Wallet Name or Transaction ID.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1bitcoinsearch_address_with_http_info(any, callback=callback_function)
    ...
    def v1bitcoinsearch_txid(self, txid, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.v1bitcoinsearch_txid_with_http_info(txid, **kwargs)
        else:
            (data) = self.v1bitcoinsearch_txid_with_http_info(txid, **kwargs)
            return data

    def v1bitcoinsearch_txid_with_http_info(self, txid, **kwargs):
        """
        Get Confirmations
        Searches for a Number of Confirmations on a transaction ID.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1bitcoinsearch_txid_with_http_info(txid, callback=callback_function)
