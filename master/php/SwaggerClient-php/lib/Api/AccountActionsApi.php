...
class AccountActionsApi
{
    ...
    /**
     * Operation v1userprofileimagedeleteNetkiName
     *
    ...
    {
        list($response) = $this->v1userprofileimagedeleteNetkiNameWithHttpInfo($netki_name, $authorization, $accept);
        return $response;
    }

    /**
     * Operation v1userprofileimagedeleteNetkiNameWithHttpInfo
     *
     * Delete Profile Image
     *
     * @param string $netki_name  (required)
    ...
    public function v1userprofileimagedeleteNetkiNameWithHttpInfo($netki_name, $authorization = null, $accept = null)
    {
        ...
        if ($netki_name === null) {
            throw new \InvalidArgumentException('Missing the required parameter $netki_name when calling v1userprofileimagedeleteNetkiName');
        }
        // parse inputs
