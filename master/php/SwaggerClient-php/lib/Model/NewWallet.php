 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class NewWallet implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'NewWallet';
    ...
    {
        $this->container['wallet_name'] = isset($data['wallet_name']) ? $data['wallet_name'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['wallet_name'] === null) {
            $invalid_properties[] = "'wallet_name' can't be null";
        }
