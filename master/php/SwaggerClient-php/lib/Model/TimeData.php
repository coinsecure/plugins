 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TimeData implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'TimeData';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['verified_time'] = isset($data['verified_time']) ? $data['verified_time'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['verified_time'] === null) {
            $invalid_properties[] = "'verified_time' can't be null";
        }
        if ($this->container['completed_time'] === null) {
            $invalid_properties[] = "'completed_time' can't be null";
        }
