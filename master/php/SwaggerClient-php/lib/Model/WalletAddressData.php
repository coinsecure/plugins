...
/**
 * WalletAddressData Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class WalletAddressData implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'WalletAddressData';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['min_conf'] = isset($data['min_conf']) ? $data['min_conf'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['min_conf'] === null) {
            $invalid_properties[] = "'min_conf' can't be null";
        }
    ...
    {
        return $this->container['min_conf'];
    }
     ...
     * @return $this
     */
    public function setMinConf($min_conf)
    {
        $this->container['min_conf'] = $min_conf;
