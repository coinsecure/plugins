...
- API version: beta
- Build date: 2016-08-21T18:37:43.299Z
...
*SecurityActionsApi* | [**v1userpasswordchange**](docs/Api/SecurityActionsApi.md#v1userpasswordchange) | **POST** /v1/user/password/change | Change Password.
