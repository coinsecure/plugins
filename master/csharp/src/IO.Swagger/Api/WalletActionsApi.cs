...
namespace IO.Swagger.Api
{
    ...
    public interface IWalletActionsApi : IApiAccessor
    {
        ...
        /// <param name="accept">JSON, XML or CSV can be returned (Optional) (optional)</param>
        /// <returns>ApiResponse of SuccessResult</returns>
        ApiResponse<SuccessResult> V1userwalletcoinwithdrawunverifiedcancelWithdrawIDWithHttpInfo (string withdrawID, string authorization, string accept = null);
        /// <summary>
        ...
        /// <param name="accept">JSON, XML or CSV can be returned (Optional) (optional)</param>
        /// <returns>Task of SuccessResult</returns>
        System.Threading.Tasks.Task<SuccessResult> V1userwalletcoinwithdrawunverifiedcancelWithdrawIDAsync (string withdrawID, string authorization, string accept = null);
        ...
        /// <param name="accept">JSON, XML or CSV can be returned (Optional) (optional)</param>
        /// <returns>Task of ApiResponse (SuccessResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<SuccessResult>> V1userwalletcoinwithdrawunverifiedcancelWithdrawIDAsyncWithHttpInfo (string withdrawID, string authorization, string accept = null);
        /// <summary>
        /// Verify Bitcoin Withdrawal
        /// </summary>
        /// <remarks>
    ...
    public partial class WalletActionsApi : IWalletActionsApi
    {
        ...
        public ApiResponse< WalletAddressDataResponse > V1userwalletcoinaddressnewWithHttpInfo (NewAddress body, string authorization = null, string accept = null)
        {
            ...
            {
                Exception exception = ExceptionFactory("V1userwalletcoinaddressnew", localVarResponse);
        ...
        public ApiResponse< WalletAddressDataResponse > V1userwalletcoinnewWithHttpInfo (NewWallet body, string authorization = null, string accept = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("V1userwalletcoinnew", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< SuccessResult > V1userwalletcoinwithdrawinitiateWithHttpInfo (SendCoinWallet body, string authorization = null, string accept = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("V1userwalletcoinwithdrawinitiate", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< SuccessResult > V1userwalletcoinwithdrawsendToExchangeWithHttpInfo (SendExchange body, string authorization = null, string accept = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("V1userwalletcoinwithdrawsendToExchange", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="accept">JSON, XML or CSV can be returned (Optional) (optional)</param>
        /// <returns>SuccessResult</returns>
        public SuccessResult V1userwalletcoinwithdrawunverifiedcancelWithdrawID (string withdrawID, string authorization, string accept = null)
        {
             ApiResponse<SuccessResult> localVarResponse = V1userwalletcoinwithdrawunverifiedcancelWithdrawIDWithHttpInfo(withdrawID, authorization, accept);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accept">JSON, XML or CSV can be returned (Optional) (optional)</param>
        /// <returns>ApiResponse of SuccessResult</returns>
        public ApiResponse< SuccessResult > V1userwalletcoinwithdrawunverifiedcancelWithdrawIDWithHttpInfo (string withdrawID, string authorization, string accept = null)
        {
            // verify the required parameter 'withdrawID' is set
            if (withdrawID == null)
                throw new ApiException(400, "Missing required parameter 'withdrawID' when calling WalletActionsApi->V1userwalletcoinwithdrawunverifiedcancelWithdrawID");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling WalletActionsApi->V1userwalletcoinwithdrawunverifiedcancelWithdrawID");

            var localVarPath = "/v1/user/wallet/coin/withdraw/unverified/cancel/{withdrawID}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("V1userwalletcoinwithdrawunverifiedcancelWithdrawID", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="accept">JSON, XML or CSV can be returned (Optional) (optional)</param>
        /// <returns>Task of SuccessResult</returns>
        public async System.Threading.Tasks.Task<SuccessResult> V1userwalletcoinwithdrawunverifiedcancelWithdrawIDAsync (string withdrawID, string authorization, string accept = null)
        {
             ApiResponse<SuccessResult> localVarResponse = await V1userwalletcoinwithdrawunverifiedcancelWithdrawIDAsyncWithHttpInfo(withdrawID, authorization, accept);
             return localVarResponse.Data;
        ...
        /// <param name="accept">JSON, XML or CSV can be returned (Optional) (optional)</param>
        /// <returns>Task of ApiResponse (SuccessResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SuccessResult>> V1userwalletcoinwithdrawunverifiedcancelWithdrawIDAsyncWithHttpInfo (string withdrawID, string authorization, string accept = null)
        {
            // verify the required parameter 'withdrawID' is set
            if (withdrawID == null)
                throw new ApiException(400, "Missing required parameter 'withdrawID' when calling WalletActionsApi->V1userwalletcoinwithdrawunverifiedcancelWithdrawID");
        ...
        public ApiResponse< SuccessResult > V1userwalletcoinwithdrawverifyWithHttpInfo (string authorization, Code body, string accept = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("V1userwalletcoinwithdrawverify", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< SuccessResult > V1walletcoinwithdrawnewVerifycodeWithHttpInfo (WithdrawID body, string authorization = null, string accept = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("V1walletcoinwithdrawnewVerifycode", localVarResponse);
                if (exception != null) throw exception;
            }
