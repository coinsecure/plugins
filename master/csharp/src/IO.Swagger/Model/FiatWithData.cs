...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FiatWithData :  IEquatable<FiatWithData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FiatWithData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FiatWithData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FiatWithData" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FiatWithData);
        }

        /// <summary>
        /// Returns true if FiatWithData instances are equal
        /// </summary>
        /// <param name="other">Instance of FiatWithData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FiatWithData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
