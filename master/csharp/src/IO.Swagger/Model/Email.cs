...
namespace IO.Swagger.Model
{
    ...
    public partial class Email :  IEquatable<Email>
    {
        ...
        /// Initializes a new instance of the <see cref="Email" /> class.
        /// </summary>
        /// <param name="_Email">_Email (required).</param>
        public Email(string _Email = null)
        {
            // to ensure "_Email" is required (not null)
            if (_Email == null)
            {
                throw new InvalidDataException("_Email is a required property for Email and cannot be null");
            }
            else
            {
                this._Email = _Email;
