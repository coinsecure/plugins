...
namespace IO.Swagger.Model
{
    ...
    public partial class SuccessLoginResponse :  IEquatable<SuccessLoginResponse>
    {
        ...
        public SuccessLoginResponse(string Info = null, string KeyType = null, string KeyNeeded = null)
        {
            // to ensure "Info" is required (not null)
            if (Info == null)
            {
                throw new InvalidDataException("Info is a required property for SuccessLoginResponse and cannot be null");
            }
            else
            {
                this.Info = Info;
