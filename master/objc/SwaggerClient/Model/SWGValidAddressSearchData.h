...
@protocol SWGValidAddressSearchData
@end

@interface SWGValidAddressSearchData : SWGObject
...
@property(nonatomic) NSNumber* unconfirmedTxApperances;

@property(nonatomic) NSNumber* txApperances;
