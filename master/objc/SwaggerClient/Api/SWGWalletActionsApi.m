...
@implementation SWGWalletActionsApi

NSString* kSWGWalletActionsApiErrorDomain = @"SWGWalletActionsApiErrorDomain";
NSInteger kSWGWalletActionsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGWalletActionsApi *sharedAPI;
...
-(NSNumber*) v1userwalletcoinaddressnewWithBody: (SWGNewAddress*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v1/user/wallet/coin/address/new"];
...
-(NSNumber*) v1userwalletcoinnewWithBody: (SWGNewWallet*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v1/user/wallet/coin/new"];
...
-(NSNumber*) v1userwalletcoinwithdrawinitiateWithBody: (SWGSendCoinWallet*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v1/user/wallet/coin/withdraw/initiate"];
...
-(NSNumber*) v1userwalletcoinwithdrawsendToExchangeWithBody: (SWGSendExchange*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v1/user/wallet/coin/withdraw/sendToExchange"];
...
-(NSNumber*) v1userwalletcoinwithdrawverifyWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v1/user/wallet/coin/withdraw/verify"];
...
-(NSNumber*) v1walletcoinwithdrawnewVerifycodeWithBody: (SWGWithdrawID*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v1/wallet/coin/withdraw/newVerifycode"];
