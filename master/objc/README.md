...
- API version: 1.0b
- Package version: 
- Build date: 2016-07-16T20:13:23.141Z
...
#import <SwaggerClient/SWGDepositID.h>
...
#import <SwaggerClient/SWGNetkiName.h>
...
#import <SwaggerClient/SWGSuccessResultList.h>
...
*SWGAccountActionsApi* | [**v1usernetkiupdate**](docs/SWGAccountActionsApi.md#v1usernetkiupdate) | **PATCH** /v1/user/netki/update | Update Netki Address
*SWGAccountActionsApi* | [**v1userprofileimagedelete**](docs/SWGAccountActionsApi.md#v1userprofileimagedelete) | **POST** /v1/user/contact | Delete Profile Image
*SWGAccountActionsApi* | [**v1userprofileimageupdate**](docs/SWGAccountActionsApi.md#v1userprofileimageupdate) | **PATCH** /v1/user/profile/image/update | Update Profile Image
...
*SWGExchangeBankActionsApi* | [**v1userexchangebankcoinwithdrawunverifiedcancel**](docs/SWGExchangeBankActionsApi.md#v1userexchangebankcoinwithdrawunverifiedcancel) | **DELETE** /v1/user/exchange/bank/coin/withdraw/unverified/cancel | Cancel Bitcoin Withdrawal
...
*SWGExchangeBankActionsApi* | [**v1userexchangebankfiatdepositcancel**](docs/SWGExchangeBankActionsApi.md#v1userexchangebankfiatdepositcancel) | **DELETE** /v1/user/exchange/bank/fiat/deposit/cancel | Cancel Unverified Exchange Fiat Deposit
...
*SWGExchangeBankActionsApi* | [**v1userexchangebankfiatwithdrawunverifiedcancel**](docs/SWGExchangeBankActionsApi.md#v1userexchangebankfiatwithdrawunverifiedcancel) | **DELETE** /v1/user/exchange/bank/fiat/withdraw/unverified/cancel | Cancel Fiat Withdrawal
...
*SWGExchangeTradeActionsApi* | [**v1userexchangeaskcancel**](docs/SWGExchangeTradeActionsApi.md#v1userexchangeaskcancel) | **DELETE** /v1/user/exchange/ask/cancel | Cancel Open Sell Order
...
*SWGExchangeTradeActionsApi* | [**v1userexchangebidcancel**](docs/SWGExchangeTradeActionsApi.md#v1userexchangebidcancel) | **DELETE** /v1/user/exchange/bid/cancel | Cancel Open Buy Order
...
*SWGSecurityActionsApi* | [**v1usermfaauthydisable**](docs/SWGSecurityActionsApi.md#v1usermfaauthydisable) | **DELETE** /v1/user/mfa/authy/disable | Disable Authy
...
*SWGSecurityActionsApi* | [**v1usermfagadisable**](docs/SWGSecurityActionsApi.md#v1usermfagadisable) | **DELETE** /v1/user/mfa/ga/disable | Disable Google Authenticator
...
*SWGSecurityActionsApi* | [**v1userpasswordchange**](docs/SWGSecurityActionsApi.md#v1userpasswordchange) | **PATCH** /v1/user/password/change | Change Password.
*SWGSecurityActionsApi* | [**v1userpasswordreset**](docs/SWGSecurityActionsApi.md#v1userpasswordreset) | **PATCH** /v1/user/password/reset | Reset Password.
...
*SWGWalletActionsApi* | [**v1userwalletcoinwithdrawunverifiedcancel**](docs/SWGWalletActionsApi.md#v1userwalletcoinwithdrawunverifiedcancel) | **DELETE** /v1/user/wallet/coin/withdraw/unverified/cancel | Cancel Bitcoin Withdrawal
...
## Documentation For Models
 ...
 - [SWGDepositID](docs/SWGDepositID.md)
 ...
 - [SWGNetkiName](docs/SWGNetkiName.md)
 ...
 - [SWGSuccessResultList](docs/SWGSuccessResultList.md)
