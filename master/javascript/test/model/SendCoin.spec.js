...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.SendCoin();
  });
  ...
  describe('SendCoin', function() {
    it('should create an instance of SendCoin', function() {
      // uncomment below and update the code to test SendCoin
      //var instane = new CoinsecureApiDocumentation.SendCoin();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.SendCoin);
    });
