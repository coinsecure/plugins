...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.OrderData();
  });
  ...
  describe('OrderData', function() {
    it('should create an instance of OrderData', function() {
      ...
      //var instane = new CoinsecureApiDocumentation.OrderData();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.OrderData);
    });
