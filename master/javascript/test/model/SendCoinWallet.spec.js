...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.SendCoinWallet();
  });
  ...
  describe('SendCoinWallet', function() {
    it('should create an instance of SendCoinWallet', function() {
      // uncomment below and update the code to test SendCoinWallet
      //var instane = new CoinsecureApiDocumentation.SendCoinWallet();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.SendCoinWallet);
    });
    ...
    it('should have the property toAddr (base name: "toAddr")', function() {
      // uncomment below and update the code to test the property toAddr
      //var instane = new CoinsecureApiDocumentation.SendCoinWallet();
      //expect(instance).to.be();
    });
