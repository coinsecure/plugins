...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.WithdrawFiat();
  });
  ...
  describe('WithdrawFiat', function() {
    it('should create an instance of WithdrawFiat', function() {
      // uncomment below and update the code to test WithdrawFiat
      //var instane = new CoinsecureApiDocumentation.WithdrawFiat();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.WithdrawFiat);
    });
