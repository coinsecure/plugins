...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.RateDiffData();
  });
  ...
  describe('RateDiffData', function() {
    it('should create an instance of RateDiffData', function() {
      // uncomment below and update the code to test RateDiffData
      //var instane = new CoinsecureApiDocumentation.RateDiffData();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.RateDiffData);
    });
