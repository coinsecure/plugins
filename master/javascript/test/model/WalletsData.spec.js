...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.WalletsData();
  });
  ...
  describe('WalletsData', function() {
    it('should create an instance of WalletsData', function() {
      // uncomment below and update the code to test WalletsData
      //var instane = new CoinsecureApiDocumentation.WalletsData();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.WalletsData);
    });
