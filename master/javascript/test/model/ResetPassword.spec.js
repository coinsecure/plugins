...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.ResetPassword();
  });
  ...
  describe('ResetPassword', function() {
    it('should create an instance of ResetPassword', function() {
      ...
      //var instane = new CoinsecureApiDocumentation.ResetPassword();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.ResetPassword);
    });
