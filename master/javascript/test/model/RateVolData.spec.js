...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.RateVolData();
  });
  ...
  describe('RateVolData', function() {
    it('should create an instance of RateVolData', function() {
      // uncomment below and update the code to test RateVolData
      //var instane = new CoinsecureApiDocumentation.RateVolData();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.RateVolData);
    });
