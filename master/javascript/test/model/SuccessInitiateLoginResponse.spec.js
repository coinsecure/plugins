...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.SuccessInitiateLoginResponse();
  });
  ...
  describe('SuccessInitiateLoginResponse', function() {
    it('should create an instance of SuccessInitiateLoginResponse', function() {
      // uncomment below and update the code to test SuccessInitiateLoginResponse
      //var instane = new CoinsecureApiDocumentation.SuccessInitiateLoginResponse();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.SuccessInitiateLoginResponse);
    });
