...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.ChangePassword();
  });
  ...
  describe('ChangePassword', function() {
    it('should create an instance of ChangePassword', function() {
      ...
      //var instane = new CoinsecureApiDocumentation.ChangePassword();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.ChangePassword);
    });
