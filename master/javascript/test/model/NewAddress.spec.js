...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.NewAddress();
  });
  ...
  describe('NewAddress', function() {
    it('should create an instance of NewAddress', function() {
      // uncomment below and update the code to test NewAddress
      //var instane = new CoinsecureApiDocumentation.NewAddress();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.NewAddress);
    });
