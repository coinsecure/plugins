...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.NumberOtp();
  });
  ...
  describe('NumberOtp', function() {
    it('should create an instance of NumberOtp', function() {
      // uncomment below and update the code to test NumberOtp
      //var instane = new CoinsecureApiDocumentation.NumberOtp();
