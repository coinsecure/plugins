...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.SignupForm();
  });
  ...
  describe('SignupForm', function() {
    it('should create an instance of SignupForm', function() {
      ...
      //var instane = new CoinsecureApiDocumentation.SignupForm();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.SignupForm);
    });
