...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.SendExchange();
  });
  ...
  describe('SendExchange', function() {
    it('should create an instance of SendExchange', function() {
      // uncomment below and update the code to test SendExchange
      //var instane = new CoinsecureApiDocumentation.SendExchange();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.SendExchange);
    });
