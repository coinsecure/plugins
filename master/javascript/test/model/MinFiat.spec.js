...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.MinFiat();
  });
  ...
  describe('MinFiat', function() {
    it('should create an instance of MinFiat', function() {
      // uncomment below and update the code to test MinFiat
