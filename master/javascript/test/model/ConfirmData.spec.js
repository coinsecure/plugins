...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.ConfirmData();
  });
  ...
  describe('ConfirmData', function() {
    it('should create an instance of ConfirmData', function() {
      ...
      //var instane = new CoinsecureApiDocumentation.ConfirmData();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.ConfirmData);
    });
