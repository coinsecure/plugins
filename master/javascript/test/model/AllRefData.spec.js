...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoinsecureApiDocumentation.AllRefData();
  });
  ...
  describe('AllRefData', function() {
    it('should create an instance of AllRefData', function() {
      // uncomment below and update the code to test AllRefData
      //var instane = new CoinsecureApiDocumentation.AllRefData();
      //expect(instance).to.be.a(CoinsecureApiDocumentation.AllRefData);
    });
