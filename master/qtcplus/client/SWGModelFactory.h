...
namespace Swagger {
  inline void* create(QString type) {
    ...
    if(QString("SWGSuccessCancelData").compare(type) == 0) {
      return new SWGSuccessCancelData();
    }
    if(QString("SWGSuccessCancelDataResponse").compare(type) == 0) {
      return new SWGSuccessCancelDataResponse();
    }
    ...
    if(QString("SWGSuccessOrderData").compare(type) == 0) {
      return new SWGSuccessOrderData();
    }
    if(QString("SWGSuccessOrderDataResponse").compare(type) == 0) {
      return new SWGSuccessOrderDataResponse();
    }
