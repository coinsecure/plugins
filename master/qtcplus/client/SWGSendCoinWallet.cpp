...
void
SWGSendCoinWallet::setWalletId(QString* wallet_id) {
...
void
SWGSendCoinWallet::setToAddr(QString* to_addr) {
...
SWGObject*
SWGSendCoinWallet::getFees() {
    return fees;
}
void
SWGSendCoinWallet::setFees(SWGObject* fees) {
    this->fees = fees;
}
