...
formParams.put("otp", ApiInvoker.parameterToString(otp));
  ...
  * Deletes a profile Image.
   ...
   * @return SuccessResult
  */
  public SuccessResult v1userprofileimagedeleteNetkiName (String netkiName, String authorization, String accept) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  
      // verify the required parameter 'netkiName' is set
      if (netkiName == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'netkiName' when calling v1userprofileimagedeleteNetkiName",
      new ApiException(400, "Missing the required parameter 'netkiName' when calling v1userprofileimagedeleteNetkiName"));
      }
  

  // create path and map variables
  String path = "/v1/user/profile/image/delete/{netkiName}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "netkiName" + "\\}", apiInvoker.escapeString(netkiName.toString()));
   ...
   * Delete Profile Image
   * Deletes a profile Image.
   * @param netkiName    * @param authorization Enter a valid Api Key.   * @param accept JSON, XML or CSV can be returned (Optional)
  */
  public void v1userprofileimagedeleteNetkiName (String netkiName, String authorization, String accept, final Response.Listener<SuccessResult> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
