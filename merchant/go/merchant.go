...
type Merchant struct {
	...
	FiatBalance int64 `json:"fiatBalance,omitempty"`
	...
	MinCoinSettlement int64 `json:"minCoinSettlement,omitempty"`

	MinFiatSettlement int64 `json:"minFiatSettlement,omitempty"`
