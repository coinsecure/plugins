...
from swagger_client.models.success_invoices import SuccessInvoices


class TestSuccessInvoices(unittest.TestCase):
    """ SuccessInvoices unit test stubs """
    ...
    def testSuccessInvoices(self):
        """
        Test SuccessInvoices
        """
        model = swagger_client.models.success_invoices.SuccessInvoices()
