...
from swagger_client.models.success_invoice import SuccessInvoice


class TestSuccessInvoice(unittest.TestCase):
    """ SuccessInvoice unit test stubs """
    ...
    def testSuccessInvoice(self):
        """
        Test SuccessInvoice
        """
        model = swagger_client.models.success_invoice.SuccessInvoice()
