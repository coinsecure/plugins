...
from swagger_client.models.success_merchant import SuccessMerchant


class TestSuccessMerchant(unittest.TestCase):
    """ SuccessMerchant unit test stubs """
    ...
    def testSuccessMerchant(self):
        """
        Test SuccessMerchant
        """
        model = swagger_client.models.success_merchant.SuccessMerchant()
