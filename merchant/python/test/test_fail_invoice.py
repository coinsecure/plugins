...
from swagger_client.models.fail_invoice import FailInvoice


class TestFailInvoice(unittest.TestCase):
    """ FailInvoice unit test stubs """
    ...
    def testFailInvoice(self):
        """
        Test FailInvoice
        """
        model = swagger_client.models.fail_invoice.FailInvoice()
