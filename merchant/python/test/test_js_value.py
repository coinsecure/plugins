...
from swagger_client.models.js_value import JsValue


class TestJsValue(unittest.TestCase):
    """ JsValue unit test stubs """
    ...
    def testJsValue(self):
        """
        Test JsValue
        """
        model = swagger_client.models.js_value.JsValue()
