...
from swagger_client.models.action_any_content import ActionAnyContent


class TestActionAnyContent(unittest.TestCase):
    """ ActionAnyContent unit test stubs """
    ...
    def testActionAnyContent(self):
        """
        Test ActionAnyContent
        """
        model = swagger_client.models.action_any_content.ActionAnyContent()
