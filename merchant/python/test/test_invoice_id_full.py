...
from swagger_client.models.invoice_id_full import InvoiceIDFull


class TestInvoiceIDFull(unittest.TestCase):
    """ InvoiceIDFull unit test stubs """
    ...
    def testInvoiceIDFull(self):
        """
        Test InvoiceIDFull
        """
        model = swagger_client.models.invoice_id_full.InvoiceIDFull()
