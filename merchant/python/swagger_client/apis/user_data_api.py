...
class UserDataApi(object):
    ...
    def get_merchant(self, api_key, **kwargs):
        """
        GET MERCHANT
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_merchant(api_key, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str api_key: Enter User Key (required)
        ...
        if ('api_key' not in params) or (params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `get_merchant`")


        resource_path = '/user/getMerchant'.replace('{format}', 'json')
        path_params = {}
        ...
        if 'api_key' in params:
            header_params['apiKey'] = params['api_key']
